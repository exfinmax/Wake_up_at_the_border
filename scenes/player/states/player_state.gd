...
# 初始化状态
func setup(context_player: Player, context_animation: AnimationPlayer, context_interact_area: Area2D, context_defend_area: Area2D, context_quest_conponent: Node2D, context_quest_manager: Node2D, context_health_component: Node2D, context_attack_component: Node2D, context_data: PlayerData) -> void:
