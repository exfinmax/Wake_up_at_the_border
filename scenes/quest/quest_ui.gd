...
@onready var quest_objectives: VBoxContainer = %QuestObjectives
@onready var quest_rewards: VBoxContainer = %QuestRewards
...
func update_quest_list():
	...
	if active_quests.size() == 0:
		clear_quest_details()
		Global.player.quest_conponent.selected_quest = null
		Global.player.quest_conponent.update_quest_tracker(null)
	else:
	...
	Global.player.quest_conponent.update_quest_tracker(selected_quest)
func _on_quest_selected(quest: Quest):
	selected_quest = quest
	Global.player.quest_conponent.selected_quest = quest
